...
public class FineLockThreadManager implements Runnable {

	List<String> lines = new ArrayList<String>();
	int startLineNumber = 0;
	int endLineNumber = 0;
	HashMap<String, List<Integer>> idToTemperatureValuesMap = new HashMap<String, List<Integer>>();
	Mutex lock = new Mutex();
	Object inputLock = new Object();
	
	public FineLockThreadManager(List<String> lines, int startLineNumber, int endLineNumber,
